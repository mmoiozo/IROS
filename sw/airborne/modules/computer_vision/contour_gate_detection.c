...
/**
 * @file modules/computer_vision/contour_gate_detection.c
 */

// Own header
#include "modules/computer_vision/contour_gate_detection.h"
#include <stdio.h>
...
void contour_gate_periodic(void)
{
  ...
  if (1){//states_race.gate_detected == 1) {
...
//   previous_best_gate.gate_q = 0.05;//best_gate.gate_q;
//   previous_best_gate.n_sides = 4;//best_gate.n_sides;
  ...
  ***************************************/
  ...
  if (0){//best_gate.gate_q > (min_gate_quality*2) && best_gate.n_sides > 3) {//n_sides was > 2
...
// 	 debug_3 = angle_error_dot*57;
  ...
  return NULL;//img; // snake_gate_detection did not make a new image
}
...
void contour_gate_detection_init(void)
{
